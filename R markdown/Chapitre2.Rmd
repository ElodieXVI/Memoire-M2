...
l'accueil de trois types de public : les établissements et services pour
personnes handicapées ● les établissements pour personnes en difficulté
sociale, ● et les établissements de la Protection de l'enfance.
...
souvent rétrospectives, nous ne les inclurons donc pas à ce panorama .
...
enquête annuelle sur les pupilles d'État .
...
gestionnaire . Elle collecte ainsi des données agrégées sur les
...
```{r, out.width="60%", fig.cap="Les champs de l'enquête sur les bénéficiaires de l'Aide sociale à l'enfance et de l'enquête ES-PE"}
...
enquête. En tout, 62 % des établissements répertoriés ont répondu .

```{r, out.width="60%",fig.cap="Taux de réponse des différents types d'établissements de l'Aide sociale à l'enfance à l'enquête ES-PE 2017"}
...
d'établissements répondants . Ainsi, le type d'établissement ayant le
...
jeunes majeurs , . Le fait que cette variable soit non comprise dans nos
...
~Source\ :\ Enquête\ ES-PE\ 2017,\ DREES.~
...
~[Source\ :\ Enquête\ ES-PE\ 2017,\ DREES.]{.smallcaps}~
...
2017 est l'âge. Ce type d'établissement semble particulièrement tourné
